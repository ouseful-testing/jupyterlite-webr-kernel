...
function isSimpleObject(value) {
  return typeof value === "object" && value !== null && !Array.isArray(value) && !ArrayBuffer.isView(value) && !isComplex(value) && !isWebRDataJs(value) && !(value instanceof Date) && !(value instanceof RegExp) && !(value instanceof Error) && !(value instanceof RObjectBase) && Object.getPrototypeOf(value) === Object.prototype;
}
